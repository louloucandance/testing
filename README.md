...
# Binome : Yoann GATHIGNOL et Louise GENTILLET
...
Non car les données manipulées sont "private" et ne peuvent donc pas être acceder autrement.
...
Non, on ne peut "jamais" être sûr de toute les possibilités d'executions.
...
Il n'est pas possible de correctement tester à cause du facteur aléatoire (random).
